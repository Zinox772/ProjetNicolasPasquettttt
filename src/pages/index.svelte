...
<script>
  ...
  onMount(async () => {
    const { data, error } = await supabase
      .from("Client")
      .select("id,surname,age,commentaire")
...
<!--Importation des membres de la famille avec les images et les commentaires-->
...
<!--Importation des commentaires de supabase -->
<section class="grid-wrap">
